...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="head">
    <head>
      ...
      <link rel="shortcut icon" href="{$WebApplicationBaseURL}favicon.ico" type="image/x-icon" />
...
<!--       </language> -->
      <li class="nav-item dropdown ml-auto mir-lang">
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" title="{i18n:translate('pp.layout.changeLanguage')}">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-sm-6 col-md-auto">
            <a href="https://perspectivia.net/" id="udeLogo" class="containsimage">
              <span>
                <xsl:value-of select="i18n:translate('pp.perspectivia')" />
              </span>
              <img src="{$WebApplicationBaseURL}images/perspectivia.net.svg" alt="Logo {i18n:translate('pp.perspectivia')}" width="1052" height="414" />
            </a>
          </div>
          <div class="col-12 col-sm-6 col-md-auto">
            <div id="orgaunitTitle">
              <a href="{$WebApplicationBaseURL}">
                <h1>
                  <xsl:value-of select="i18n:translate('pp.ubo')" />
                </h1>
                <h2>
                  <xsl:value-of select="i18n:translate('pp.ubo.subTitle')" />
                </h2>
              </a>
            </div>
          </div>
          <div class="col-12 col-md">
            <form action="{$WebApplicationBaseURL}servlets/solr/select" class="searchfield_box form-inline my-2 my-lg-0" role="search">
              <div class="input-group mb-3">
                <input id="searchInput" class="form-control mr-sm-2 search-query" type="search" name="qq" placeholder="{i18n:translate('pp.layout.searchPublications')}" aria-label="{i18n:translate('pp.layout.searchPublications')}" />
      ...
      <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
          ...
          <button class="navbar-toggler" type="button"
            ...
            aria-controls="mir-main-nav-collapse-box" aria-expanded="false" aria-label="{i18n:translate('pp.layout.toggleNavigation')}">
    ...
    <nav class="rootline" aria-label="breadcrumb">
      <ol class="breadcrumb py-1" vocab="http://schema.org/" typeof="BreadcrumbList">
        <li class="breadcrumb-item" property="itemListElement" typeof="ListItem">
          <a href="https://perspectivia.net/" property="item" typeof="WebPage">
            <i class="fas fa-home mr-2" />
            <xsl:text>perspectivia.net</xsl:text>
          </a>
        </li>
        <li class="breadcrumb-item" property="itemListElement" typeof="ListItem">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col" id="footerLogo">
              <a href="https://perspectivia.net/images/logos/max-weber-stiftung-de.svg" class="containsimage">
                <img src="{$WebApplicationBaseURL}images/LogoLwhite.svg" class="mb-5" alt="Logo Max Weber Stiftung" />
              </a>
            </div>
            ...
            <div class="col col-md-auto justify-content-end">
              ...
              <div id="footerCopyright" class="navbar">
                <ul class="nav">
                  <li>
                    <xsl:value-of select="i18n:translate('pp.layout.copyright')" />
                  </li>
                  <li>
                    <a href="mailto:{i18n:translate('pp.contact.mail')}" class="footer-menu__entry">
                      <i class="fas fa-fw fa-envelope" />
                      <xsl:value-of select="i18n:translate('pp.contact.mail')" />
                    </a>
                  </li>
                </ul>
              </div>
